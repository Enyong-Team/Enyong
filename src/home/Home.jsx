    ...
    <div className="min-h-screen w-full max-w-full overflow-hidden p-5 flex flex-col items-center gap-5 relative z-0">
      ...
      <div className="flex flex-row justify-between w-full  items-start">
        ...
        <img
          ...
          className="w-[50px] h-12 
                       ...
                       cursor-pointer active:scale-95" // about button size to
          onClick={() =>
        ...
        <div className="flex flex-row gap-4">
          <Link to="/account">
            <img
              ...
              className="w-[50px] h-12 
                                  max-[380px]:w-9 max-[380px]:h-9 
                                  cursor-pointer active:scale-95" // account button size to
            />
          </Link>
          ...
          <img
            ...
            className="w-[50px] h-12 
                                max-[380px]:w-9 max-[380px]:h-9 
                                cursor-pointer active:scale-95" // setting button size
            onClick={() =>
      ...
      <div className="flex justify-center items-center flex-col mb-5 max-[380px]:-mt-5">
        ...
        <img
          src={depedPic}
          alt="deped"
          className="w-[295px] h-[236px] 
                        max-[380px]:w-50 max-[380px]:h-50" // Title Logo size to
        />
      ...
      >
        ...
        >
          <div className=" w-[90%] rounded-xl p-3 flex flex-col gap-3 items-center justify-center ">
            <h1 className="font-LG text-white text-center">
              Scan a QR code to challenge a friend in a quiz battle.
            </h1>
        ...
        >
          <div className=" w-[90%] rounded-xl p-3 flex flex-col gap-3 items-center justify-center ">
            <h1 className="font-LG text-white text-center">
              Answer fun questions to collect more coins and unlock rewards.
            </h1>
            <Link to={"/earnCoins"}>
              <img
                src={playPic}
        ...
        >
          <div className=" w-[90%] rounded-xl p-3 flex flex-col gap-3 items-center justify-center ">
            <h1 className="font-LG text-white text-center">
              Replay lesson-based games by level and quarter to review and
              improve.
            </h1>
