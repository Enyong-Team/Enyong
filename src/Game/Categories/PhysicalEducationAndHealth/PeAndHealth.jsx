...
import PELogo from "../CategoriesLogo/PELogo.png"; 
...
function PEAndHealth() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      navigate("/game", { state: { subject: "PE And Health" } });
    }, 300);
    ...
    <div className="min-h-screen bg-[#081E41] flex flex-col text-white">
      <div className="font-FD flex flex-col items-center justify-center m-10">
        <div className="flex flex-col items-center justify-center gap-14">
          ...
          <h1 className="text-4xl text-center">PE And Health</h1>
        </div>

        <div>
          <img src={PELogo} alt="PEAndHealth logo" className="pt-25" />
        </div>
      </div>
    </div>
  );
